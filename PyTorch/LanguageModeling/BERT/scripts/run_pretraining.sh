...
learning_rate=${learning_rate:-"6e-3"}
precision=${precision:-"fp16"}
num_gpus=${num_gpus:-1}
warmup_proportion=${warmup_proportion:-"0.2843"}
...
accumulate_gradients=${accumulate_gradients:-"true"}
gradient_accumulation_steps=${gradient_accumulation_steps:-128}
seed=${seed:-12439}
job_name=${job_name:-"bert_lamb_pretraining"}
allreduce_post_accumulation=${allreduce_post_accumulation:-"true"}
allreduce_post_accumulation_fp16=${allreduce_post_accumulation_fp16:-"true"}
train_batch_size_phase2=${train_batch_size_phase2:-4096}
learning_rate_phase2=${learning_rate_phase2:-"4e-3"}
warmup_proportion_phase2=${warmup_proportion_phase2:-"0.128"}
train_steps_phase2=${train_steps_phase2:-1563}
gradient_accumulation_steps_phase2=${gradient_accumulation_steps_phase2:-512}
...
DATA_DIR_PHASE1=${DATA_DIR_PHASE1:-/data/hdf5/${DATASET}/}
...
DATA_DIR_PHASE2=${DATA_DIR_PHASE2:-/data/hdf5/${DATASET2}/}
